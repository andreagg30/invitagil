...
function Invitation() {
  ...
  return (
    <div className="h-screen overflow-auto w-full bg-[radial-gradient(circle,rgba(255,255,255,.6)_2px,transparent_2px)] flex flex-col bg-size-[30px_30px] bg-position-[0_0] bg-blue-100">
      <div className="flex z-10 flex-col items-center justify-center">
        <div className="h-125 w-150 relative justify-center items-center flex flex-col">
          <img
            src="/IMG_1929.png"
            className="absolute"
            height="600px"
          ...
          <div className="flex justify-center pb-1 z-10 w-full text-center">
            <span className="cursive text-6xl  font-bold text-primary-blue">
              Baby shower
            </span>
          </div>
          ...
          <div className="flex absolute justify-center bottom-15 z-10 w-full">
            <div className="w-30 h-30 flex justify-center items-center ">
              <img
                src="/pato.png"
                className="absolute animate-[breathe_2.6s_ease-in-out_infinite] motion-reduce:animation-none"
                height="300px"
                width="300px"
              />
            </div>
      ...
      <div className="flex z-10 gap-5 items-center justify-center flex-col">
        ...
        <div className="flex w-112.5 shadow-md px-10 py-7 h-full bg-white/70 gap-5 rounded flex-col items-center justify-center">
          <div className="flex gap-4 sm:gap-6 justify-center">
            <div className="font-script text-3xl sm:text-4xl cursive text-primary-brown">
              Viernes
            </div>

            <div className="h-10 sm:h-12 w-0.5 bg-primary-brown" />

            <div className="font-invite text-5xl sm:text-6xl cinzel leading-none text-primary-brown">
              17
            </div>
          ...
          <div className="font-script text-5xl cinzel text-primary-brown">
            ABRIL
          </div>
        </div>

        <div className="flex gap-5 w-112.5 shadow-md px-10 py-7 h-full bg-white/70 flex-col rounded ">
          <div className="flex gap-5 justify-center items-center">
            <span className="text-primary-brown text-2xl cinzel">SALÓN:</span>

            <span className="cursive text-5xl text-primary-brown">
              Cielito Mío
            </span>
          </div>
          <Divider />
