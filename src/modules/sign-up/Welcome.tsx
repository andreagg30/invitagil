...
export function Welcome() {
  return (
    <div className="p-0 px-10 relative overflow-hidden mt-20 flex-col flex gap-2 flex-1 max-w-140 w-[calc(100vw-24px)">
      ...
      <p className="text-xl text-dark-text">Y comienza a diseñar momentos </p>
      ...
      <div className="flex gap-3">
        <div className="flex-1 flex items-center gap-2 pr-3">
          ...
          <div className="flex-1">
            <p className="text-dark-text mt-3 text-xs">DISEÑOS <br/> PERSONALIZADOS</p>
          </div>
        </div>
        <div className="flex-1 flex items-center gap-2">
          <Icon icon="mobile_2" className="text-flower mt-3" />
          <div className="flex-1">
            <p className="text-dark-text mt-3 text-xs">LISTOS PARA <br/> COMPARTIR</p>
          </div>
        </div>
        <div className="flex-1 flex items-center gap-3">
          <Icon icon="calendar_month" className="text-flower mt-3" />
          <div className="flex-1">
            <p className="text-dark-text mt-3 text-xs">FUNCIONES <br/> INTERACTIVAS</p>
          </div>
        </div>
      </div>
